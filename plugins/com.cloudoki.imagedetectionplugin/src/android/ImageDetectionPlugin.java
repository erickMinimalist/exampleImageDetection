...
public class ImageDetectionPlugin extends CordovaPlugin implements SurfaceHolder.Callback {
    ...
    public boolean execute(String action, JSONArray data,
        ...
        if(action.equals("startProcessing")) {
            ...
            if(argVal) {
				if (camera == null) {
					setCameraIndex(CAMERA_ID_BACK);
			        openCamera();
					this.surfaceChanged (surfaceHolder, 0, surfaceWidth, surfaceHeight);
					message = "Camera re-initialized. > ";
				}
				processFrames = true;
		...
		if(action.equals("stop")) {
			...
			String message = "Image Detection stopped!";
			callbackContext.success(message);
